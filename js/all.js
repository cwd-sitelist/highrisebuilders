...
(function ($, window, document, underfined) {
  ...
  function topBannerHeight() {
    ...
    var footerH =
      $(".highrise-footer").not(".highrise-footer.modern").outerHeight() || 0;
  ...
  function comingSoonValue() {
    if ($(".highrise-coming-time-wrapper .coming-time-item").length) {
      var comingSoonElements = $(
        ".highrise-coming-time-wrapper .coming-time-item"
      );
  ...
  $(".highrise_filter_projects .highrise_filter_item li").on(
    "click",
    function (e) {
      $(this).toggleClass("active");
      e.preventDefault();
  ...
  $(".highrise_filter_link_wrapper .filter-btn").on("click", function (e) {
    ...
    $(
      ".highrise_services, .highrise_books, .highrise_exhibition_grid, .highrise_grid, .highrise_masonry"
    ).isotope({
  ...
  $(".filter-clear-all").on("click", function (e) {
    $(".highrise_filter_projects .highrise_filter_item li").removeClass(
      "active"
    );
    e.preventDefault();
  });
  ...
  $(".highrise_timeline .project-timeline-item .time-item-link").on(
    "click",
    function (e) {
 ...
 */
  ...
  $(".highrise_categories_btn .categories_btn_up").on("click", function () {
    var prevCategory = $(this)
      .closest(".highrise-categories-outer")
      .prev(".highrise-categories-outer")
      .offset().top;
  ...
  $(".highrise_categories_btn .categories_btn_down").on("click", function () {
    var nextCategory = $(this)
      .closest(".highrise-categories-outer")
      .next(".highrise-categories-outer")
      .offset().top;
  ...
  function highriseGrid() {
    var block =
      ".highrise_services, .highrise_books, .highrise_media, .highrise_exhibition_grid, .highrise_grid";
  ...
  $(".protect-page").on("submit", function (e) {
    ...
    if ($("#pwbox-1234").val() == "enter") {
      ...
      $(".highrise-protected-content p").html(
    ...
    if (pageNum <= max) {
      $.ajax({
        ...
        success: function (data) {
          ...
          if (
            $container.hasClass("highrise-blog-grif-outer") ||
            $container.hasClass("highrise_blog")
          ) {
            // console.log('second');
